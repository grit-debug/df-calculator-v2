...
@app.get("/app2.html", include_in_schema=False)
def serve_app2_html():
    filepath = os.path.join(frontend_dir, "app2.html")
    with open(filepath, "rb") as f:
        content = f.read()
    return Response(content=content, media_type="text/html",
        headers={"Cache-Control": "no-store, no-cache", "Pragma": "no-cache"})

for _jsfile in ["app_p1.js", "app_p2.js", "app_p3.js", "app_p4.js", "app_p5.js",
                 "app_part1.js", "app_part2.js", "app.js"]:
